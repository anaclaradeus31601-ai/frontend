    ...
    <div className="w-screen h-screen flex items-center justify-center bg-zinc-950">
      <div className="text-center space-y-8 px-4">
        ...
        <div className="space-y-4">
          ...
          <h2 className="text-2xl font-semibold text-zinc-200">Acesso Negado</h2>
          <p className="text-zinc-400 max-w-md mx-auto">
            Desculpe, você não tem permissão para acessar este recurso. Se acredita que isso é um erro, entre em contato com o administrador.
          </p>
        </div>
